...
export const Header: React.FC = () => {
  ...
  return (
    <header className="flex w-[1280px] justify-between items-center fixed -translate-x-2/4 backdrop-blur-2xl z-[1000] bg-[rgba(8,8,8,0.90)] px-8 py-4 rounded-[30px] left-2/4 top-[60px] max-md:w-[90%] max-md:px-6 max-md:py-3 max-sm:w-[95%] max-sm:px-5 max-sm:py-2.5">
